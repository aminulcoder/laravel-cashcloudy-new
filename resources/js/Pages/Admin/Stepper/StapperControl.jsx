...
const StapperControl = ({ handleClick, currentStep, steps }) => {
  return (
    <div className="container  space-y-2  mb-5 px-5">
      {/* Next/Confirm button */}
      <button
      ...
      {/* <button
        onClick={() => handleClick()}
        className={`bg-white text-slate-400 uppercase top-0 py-2 px-4 rounded-xl font-semibold cursor-pointer border-2 border-slate-300 hover:bg-slate-700 group-hover:text-white transition duration-200 ease-in-out w-full sm:w-[45%] mb-4 sm:mb-0  ${
