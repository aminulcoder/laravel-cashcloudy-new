...
const Amount = () => {
  return (
    ...
    <div className="">
      <div>
        <label for="price" class=" text-start block font-Inter sm:text-sm text-sm/6 font-medium text-[#344054]">You send</label>
        <div class="mt-2">
    ...
    <p className="text-start text-[#475467] text-sm font-Inter sm:text-sm py-1">You have <strong className="text-gray-950">100 USD </strong>available in your balance </p>
